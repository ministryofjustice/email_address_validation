...
Gem::Specification.new do |spec|
  ...
  spec.description   = "Gem to validate various aspects of user's email address.  It will enable checks to take place prior to submission to ensure the user has entered a valid email address"
